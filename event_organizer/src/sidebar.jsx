                ...
                <div className="flex-1 space-y-8">
                    ...
                    <div>
                        ...
                        <nav className="space-y-2">
                            <a href="#" className="flex items-center space-x-3 text-white hover:bg-blue-500 rounded-lg px-3 py-2 transition-colors">
                            ...
                            <a href="#" className="flex items-center space-x-3 text-blue-200 bg-blue-500 rounded-lg px-3 py-2">
                                <svg className="w-5 h-5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
